...
import { sendStudentTelegramTest, type StudentTelegramTestActionState } from "@/app/students/actions";

export function StudentTelegramTestButton({ studentId }: { studentId: string }) {
  const [state, formAction, pending] = useActionState(sendStudentTelegramTest, {} as StudentTelegramTestActionState);
